<template>
    <section class="portfolio-detail">
        <div class="container">
            <!-- full images -->
            <div class="full-img">
                <img src='https://i.ibb.co/72Pkrg1/nts-full.jpg' alt="">
            </div>
            <!-- portfolio details -->
            <div class="project-detail">
                ...
                <div class="contents">
                    ...
                    <p>부산 연제구 소재 부산지방국세청 사이트를 리뉴얼하였습니다. <br>
                    사이트 특성상 주로 이용되는 서비스 관련 메뉴들은 이모티콘을 추가하여 편의성을 높였으며, <br>
                     불필요한 메뉴들은 없애고 간소화 하였습니다.
                    </p>
                </div>
                <!-- 스킬안내등 -->
                <div class="infos">
                    <ul>
                        ...
                        <li>
                            <span>view code</span>
                            <p><a href='https://github.com/kimjihun-dev/nts' class="github" target="_blank">github</a></p>
                        </li>
                        <li>
                            <span>view site</span>
                            <p><a href='https://kimjihun-dev.github.io/nts/' class="demo" target="_blank">demo</a></p>
                        </li>
                    </ul>
                </div>
            </div>
