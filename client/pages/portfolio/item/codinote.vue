<template>
    <section class="portfolio-detail">
        <div class="container">
            <!-- full images -->
            <div class="full-img">
                <img src='https://i.ibb.co/QYV6H9S/codinote.jpg' alt="">
            </div>
            <!-- portfolio details -->
            <div class="project-detail">
                ...
                <div class="contents">
                    ...
                    <p>
                        디자인된 시안을 바탕으로 앱 메인화면을 퍼블리싱 하였습니다.
                    </p>
                </div>
                <!-- 스킬안내등 -->
                <div class="infos">
                    <ul>
                        ...
                        <li>
                            <span>view code</span>
                            <p><a href='https://github.com/kimjihun-dev/codinote' class="github" target="_blank">github</a></p>
                        </li>
                        <li>
                            <span>view site</span>
                            <p><a href='https://kimjihun-dev.github.io/codinote' class="demo" target="_blank">demo</a></p>
                        </li>
                    </ul>
                </div>
            </div>
